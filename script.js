const data = {
  ...
  roleViews: [
    ...
    },
    {
      ...
      accent: "#2F80ED",
      summary: "09/25-09/27 里斯本三人间已订；9/26 里斯本郊区海边一日游，9/27 三个人一起去波尔图，建皇当晚住 ABC Hotel Porto Campanha，娘娘当晚飞回阿姆斯特丹。",
      ...
      facts: [
        ["里斯本住宿", "09/25-09/27", "The Delight Hostel 三人间已订"],
      ...
      focusDays: [
        ["09/26", "里斯本郊区海边一日游", "建皇 + 建建 + 娘娘，09:00 从里斯本市区出发；地狱之口、罗卡角、雷加莱拉庄园、辛特拉王宫、佩纳宫。"],
        ["09/27", "三个人去波尔图", "里斯本到波尔图约 3.5 小时，下午玩波尔图；建皇当晚住 ABC Hotel Porto Campanha。"],
        ["09/28", "建皇飞巴黎转冰岛", "建皇 09:05 从波尔图机场出发，12:15 落地巴黎奥利机场，航班易捷航空 U24886；娘娘已在 09/27 晚飞回阿姆斯特丹。"],
        ["09/30", "已订：Kerlingarfjoll 高地徒步团（¥2568.57/2人）", "已订 Kerlingarfjoll Hiking Tour，具体接送、集合时间和徒步路线以确认单为准。<a href=\"https://cn.adventures.is/iceland/day-tours/hiking/kerlingarfjoll-hiking-tour/\" target=\"_blank\" rel=\"noreferrer\">查看团页</a>"],
    ...
    },
    {
      ...
      focusDays: [
        ["10/03", "抵达冰岛 + 已订黄金圈下午团", "06:20 从哥本哈根飞雷克雅未克凯夫拉维克机场，07:40 落地；先去林德城河酒店寄存行李/入住，约 10:00 和建皇会合、一起吃早午饭后出发参加已订黄金圈下午团，晚上六个人追极光。"],
        ["10/04", "南岸两日已订", "Nice Travel 六人团定金已付；接送点和出发时间待确认。"],
  ...
  hotel: {
    ...
    checkout: "各组按离开冰岛时间退房：建皇 10/06 白天退房、晚上离开；海港组 10/08 离开；彤燕组 10/10 清晨离开",
  ...
  staySchedule: [
    {
      ...
      status: "已订",
      detail: "09/25 14:00 后入住、09/27 11:30 前退房。经济三人间，1 张双人床 + 1 张单人床，带私人浴室，不含早餐；订单号和联系方式不放公开页。",
    ...
    },
    {
      ...
      status: "已订",
      detail: "09/27 晚入住、09/28 早上退房；地址：R. de Pinto Bessa 528；电话：+351229765410。09/28 早班机前从酒店前往波尔图机场。",
      audiences: ["jianhuang"],
      accent: "#d76d45",
      mapUrl: "https://www.google.com/maps/search/?api=1&query=ABC%20Hotel%20Porto%20Campanha%20R.%20de%20Pinto%20Bessa%20528",
    },
    {
      date: "09/29-10/03",
      nights: "4 晚 / 1 间",
    ...
    },
    {
      ...
      name: "Fosshotel Lind（林德城河酒店）",
      status: "同酒店",
      detail: "建皇 10/06 白天退房、傍晚离开冰岛后，海港组 + 彤燕组继续住林德城河酒店；10/04 晚南岸团含住宿除外。金额、房间数和订单号不放公开页。",
  ...
  recommendedPlan: [
    {
      date: "10/03 周六",
      title: "已订：黄金圈下午团（¥691.31/人） + 六人追极光",
      status: "建皇上午休息；约 10:00 与海港组会合、吃早午饭后参加已订黄金圈下午团；彤燕组 15:10 到冰岛后六人齐",
      plan: "建皇上午休息，海港组抵达并寄存行李后约 10:00 会合、一起吃早午饭，再按确认单参加黄金圈下午团；彤燕组落地后去林德城河酒店，晚上六个人追极光。",
      avoid: "今天已经有黄金圈和夜间极光，别再叠加斯奈山半岛、冰河湖这种长距离路线；第二天南岸团出发时间以确认单为准。",
  ...
  coreDays: [
    {
      date: "10/03 周六夜",
      title: "已订：黄金圈下午团（¥691.31/人） + 六人追极光团",
      route: "上午休息 / 10:00 会合早午饭 → 黄金圈下午团 → 六人会合 → 追极光团",
      why: "建皇上午休息，海港组抵达后约 10:00 会合、吃早午饭，再参加已订的黄金圈下午团；彤燕组 15:10 到冰岛后，冰岛六人正式齐，晚上再参加追极光团。",
      checkpoints: ["10:00 会合 / 早午饭", "黄金圈下午团", "六人会合", "晚饭 / 补给", "追极光团"],
      details: [
        ["上午 / 下午", "建皇上午休息；海港组抵达、寄存行李后约 10:00 会合，一起吃早午饭后参加已订的黄金圈下午团，具体时间以确认单为准。"],
  ...
  personPlans: [
    {
      id: "jianhuang",
      name: "建皇",
      role: "建皇组合：09/25-09/27 里斯本三人间已订；9/26 和娘娘三个人走里斯本郊区海边一日游，9/27 一起去波尔图；10/04-10/05 Nice Travel 六人南岸两日团已订并支付定金。",
      color: "#2F80ED",
      days: [
        ["09/25", "北京 → 伦敦中转 → 里斯本", "13:35 从北京首都机场 T3 起飞，17:40 落地伦敦希思罗机场 T2；伦敦中转 1 小时 05 分，18:45 从伦敦希思罗机场 T2 起飞，21:35 落地里斯本机场 T1。落地后入住已订的 The Delight Hostel 三人间。"],
        ["09/26", "里斯本郊区海边一日游", "建皇组合 + 娘娘三个人报名这个专业路线：09:00 从里斯本市区出发，10:00 地狱之口，10:50 罗卡角，12:00 雷加莱拉庄园，14:30 辛特拉王宫，16:00 佩纳宫。主打大西洋海岸、欧亚大陆最西端、雷加莱拉庄园创始之井和两座宫殿；当天不再叠加里斯本市区重行程。"],
        ["09/27", "里斯本 → 波尔图", "早上和娘娘一起坐约 3.5 小时大巴从里斯本到波尔图；下午玩老城河岸、路易一世大桥、杜罗河边，晚上入住 ABC Hotel Porto Campanha，地址 R. de Pinto Bessa 528，电话 +351229765410。"],
        ...
        ["09/29", "巴黎 → 冰岛 + 史费拉浮潜（已订 ¥2585.04/2人）", "06:00 从巴黎戴高乐机场 T2D 起飞，07:50 落地雷克雅未克凯夫拉维克机场，航班易捷航空 U24629；飞行 3 小时 50 分。落地后进雷克雅未克市区放行李/换保暖衣物，再去辛格维利尔国家公园参加 12:00 那班史费拉裂缝浮潜，建议 11:45 前到集合点；约 17:00 结束返回，晚上雷克雅未克市区吃饭和轻量 CityWalk。<a href=\"https://cn.adventures.is/iceland/day-tours/snorkeling-and-diving/into-the-blue/\" target=\"_blank\" rel=\"noreferrer\">查看团页</a>"],
        ["09/30", "已订：Kerlingarfjoll 高地徒步团（¥2568.57/2人）", "已订 Kerlingarfjoll Hiking Tour；具体接送、集合时间和徒步路线以确认单为准。<a href=\"https://cn.adventures.is/iceland/day-tours/hiking/kerlingarfjoll-hiking-tour/\" target=\"_blank\" rel=\"noreferrer\">查看团页</a>"],
    ...
    },
    {
      id: "tongyan",
      name: "彤燕组",
      role: "两个人：10/03 下午到冰岛；10/06 建皇晚飞后，和海港组四个人包车；10/10 早上回布鲁塞尔。",
      color: "#27AE60",
      days: [
    ...
    },
    {
      ...
      color: "#8E6AC8",
      days: [
        ["09/25", "阿姆斯特丹 → 里斯本", "19:40 从阿姆斯特丹史基浦机场起飞，21:50 落地里斯本机场 T1；飞行 2 小时 10 分，无中转。落地后入住已订的 The Delight Hostel 三人间。"],
  ...
  spots: [
    {
      ...
      city: "里斯本周边",
      title: "里斯本郊区海边一日游",
      image: "assets/spots/portugal/cabo-da-roca-sunset.jpg",
      images: ["assets/spots/portugal/cabo-da-roca-sunset.jpg", "assets/spots/portugal/boca-do-inferno.jpg", "assets/spots/portugal/regaleira-initiation-well.jpg", "assets/spots/portugal/sintra-national-palace.jpg", "assets/spots/portugal/pena-palace-exterior.jpg"],
    ...
    },
    {
      ...
      transport: "Arctic Adventures 斯奈山半岛小团；雷克雅未克接送，约 11 小时，以确认单为准",
      date: "10/01",
      city: "斯奈山半岛",
      title: "斯奈山半岛小团（已订 ¥1772.5/2人）",
      image: "assets/spots/tourlink/snaefellsnes-aa-1.jpg",
      images: ["assets/spots/tourlink/snaefellsnes-aa-1.jpg", "assets/spots/tourlink/snaefellsnes-aa-2.jpg", "assets/spots/tourlink/snaefellsnes-aa-3.jpg"],
      bestTime: "全天，按确认单",
      open: "已订斯奈山半岛一日团；具体接送点、出发时间和停靠顺序以旅行社确认单为准。",
    ...
    },
    {
      ...
      transport: "Arctic Adventures 超级吉普团；雷克雅未克接送，具体出发和返回以确认单为准",
      date: "10/02",
      city: "冰岛高地",
      title: "兰德曼那劳卡高地超级吉普一日团（已订 ¥3260.37/2人）",
      image: "assets/spots/tourlink/landmannalaugar-aa-2.jpg",
      images: ["assets/spots/tourlink/landmannalaugar-aa-2.jpg", "assets/spots/tourlink/landmannalaugar-aa-3.jpg", "assets/spots/iceland/landmannalaugar-1.jpg"],
      bestTime: "全天，按确认单",
      open: "已订兰德曼那劳卡高地超级吉普一日团；具体接送点、出发时间、路线、温泉停留和返回时间以确认单为准。",
    ...
    },
    {
      ...
      transport: "Arctic Adventures Kerlingarfjoll 高地徒步团；具体接送以确认单为准",
      date: "09/30",
      city: "Kerlingarfjoll 高地",
      title: "Kerlingarfjoll 高地徒步团（已订 ¥2568.57/2人）",
      image: "assets/spots/iceland/landmannalaugar-1.jpg",
    ...
    },
    {
      ...
      category: "iceland",
      segments: ["jianhuang-spots"],
      participant: "建皇组合 09/29 想订",
      transport: "Arctic Adventures 史费拉浮潜团；选择 12:00 场次，自行到辛格维利尔国家公园集合",
      date: "09/29",
      city: "辛格维利尔国家公园",
      title: "史费拉裂缝浮潜 + 雷克雅未克市区（已订 ¥2585.04/2人）",
      image: "assets/spots/tourlink/silfra-snorkel-1.jpg",
      images: ["assets/spots/tourlink/silfra-snorkel-1.jpg", "assets/spots/tourlink/silfra-snorkel-2.jpg", "assets/spots/tourlink/silfra-snorkel-3.jpg", "assets/spots/iceland/reykjavik-harpa.jpg"],
      bestTime: "12:00 场次，建议 11:45 前到集合点；约 17:00 结束",
      open: "团页写全年运营，含专业向导、史费拉入场费、浮潜装备、干衣装备、热可可和导游拍照；具体集合点、交通和结束时间以确认单为准。",
      sunset: "雷克雅未克 09/29 日出约 07:29 / 日落约 19:04",
      viewpoint: "史费拉裂缝是在北美板块和欧亚板块之间浮潜，水非常清澈；回城后只安排雷克雅未克市区轻量散步。",
      notes: [
        "落地当天先放行李、吃东西、换保暖衣物，再去 12:00 浮潜场次。",
        "穿贴身保暖内层和厚袜子，干衣里面也会冷；不要戴隐形眼镜以外不适合进水的物品。",
        "17:00 左右结束后回雷克雅未克市区，晚上只做吃饭、补给和早睡。",
    ...
    },
    {
      ...
      city: "冰岛南岸",
      title: "南岸两日 + 蓝冰洞",
      image: "assets/spots/tourlink/nice-south-waterfall-1.jpg",
      images: ["assets/spots/tourlink/nice-south-waterfall-1.jpg", "assets/spots/reynisfjara.jpg", "assets/spots/gallery/reynisfjara-seljalandsfoss.jpg", "assets/spots/gallery/reynisfjara-skogafoss.jpg", "assets/spots/iceland/jokulsarlon-1.jpg", "assets/spots/iceland/diamond-beach-1.jpg"],
    ...
    },
    {
      ...
      participant: "建皇组合 + 海港组 10/03 已订",
      transport: "Arctic Adventures 黄金圈下午团；约 10:00 与海港组会合，早午饭后出发，具体时间以确认单为准",
      date: "10/03",
      city: "雷克雅未克 / 黄金圈",
      ...
      bestTime: "下午，具体时间以确认单为准",
      open: "已订 Arctic Adventures 黄金圈下午团；建皇上午休息，约 10:00 与海港组会合，早午饭后出发。",
      sunset: "雷克雅未克 10/03 日落约 18:50",
      viewpoint: "辛格维利尔国家公园、盖歇尔间歇泉、黄金瀑布。",
      notes: ["10/03 已订 Arctic Adventures 黄金圈下午团，价格 ¥691.31/人。", "建皇上午休息，等待海港组约 10:00 到达；一起吃早午饭后出发。", "晚上六人追极光，白天不要再安排其他重行程。", "<a href=\"https://cn.adventures.is/iceland/day-tours/golden-circle-tours/golden-circle-afternoon/\" target=\"_blank\" rel=\"noreferrer\">打开 Arctic Adventures 团页</a>"],
    },
    {
      id: "snaefellsnes",
      category: "iceland",
    ...
    },
    {
      ...
      city: "东南冰岛",
      title: "杰古沙龙冰河湖 / 钻石沙滩",
      image: "assets/spots/iceland/jokulsarlon-1.jpg",
      images: ["assets/spots/iceland/jokulsarlon-1.jpg", "assets/spots/iceland/jokulsarlon-2.jpg", "assets/spots/iceland/diamond-beach-1.jpg"],
      bestTime: "白天",
...
const dailyVisuals = {
  ...
  "jianhuang|09/26": { city: "里斯本周边", sunrise: "07:27", sunset: "19:27", season: "辛特拉山里偏凉，罗卡角海风大；9 月底海边光线很适合拍悬崖、海岸、庄园和宫殿。", images: ["assets/spots/portugal/cabo-da-roca-sunset.jpg", "assets/spots/portugal/boca-do-inferno.jpg", "assets/spots/portugal/regaleira-initiation-well.jpg", "assets/spots/portugal/sintra-national-palace.jpg", "assets/spots/portugal/pena-palace-exterior.jpg"] },
  ...
  "jianhuang|09/29": { city: "雷克雅未克 / 史费拉", sunrise: "07:29", sunset: "19:04", season: "刚到冰岛，9 月底白天还有足够光线；史费拉水温很低，浮潜后只适合雷克雅未克市区轻量吃饭和散步。", images: ["assets/spots/tourlink/silfra-snorkel-1.jpg", "assets/spots/tourlink/silfra-snorkel-2.jpg", "assets/spots/tourlink/silfra-snorkel-3.jpg", "assets/spots/iceland/reykjavik-harpa.jpg"] },
  "jianhuang|09/30": { city: "Kerlingarfjoll 高地", sunrise: "07:31", sunset: "18:59", season: "Kerlingarfjoll 高地 9 月底天气变化很快，徒步必须以向导和当天安全判断为准。", images: ["assets/spots/iceland/landmannalaugar-1.jpg", "assets/spots/iceland/landmannalaugar-2.jpg", "assets/spots/iceland/landmannalaugar-3.jpg"] },
  "jianhuang|10/01": { city: "斯奈山半岛", sunrise: "07:35", sunset: "18:57", season: "斯奈山 10 月初海风强、云层变化快，半岛瀑布、海岸线、黑教堂和教会山都适合阴天氛围。", images: ["assets/spots/tourlink/snaefellsnes-aa-1.jpg", "assets/spots/tourlink/snaefellsnes-aa-2.jpg", "assets/spots/tourlink/snaefellsnes-aa-3.jpg"] },
  "jianhuang|10/02": { city: "雷克雅未克 / 兰德曼那劳卡高地", sunrise: "07:38", sunset: "18:54", season: "10 月初高地天气变化很快，彩色山、熔岩地貌和温泉区很美，但必须听专业团安排。", images: ["assets/spots/tourlink/landmannalaugar-aa-2.jpg", "assets/spots/tourlink/landmannalaugar-aa-3.jpg", "assets/spots/iceland/landmannalaugar-1.jpg"] },
  "jianhuang|10/03": { city: "雷克雅未克 / 黄金圈", sunrise: "07:41", sunset: "18:50", season: "10 月初黄金圈白天风冷，下午光线适合看辛格维利尔、盖歇尔和黄金瀑布；建皇上午休息，晚上六人追极光。", images: ["assets/spots/gullfoss.jpg", "assets/spots/iceland/thingvellir-1.jpg", "assets/spots/iceland/strokkur-1.jpg"] },
  "jianhuang|10/04": { city: "冰岛南岸", sunrise: "07:33", sunset: "18:38", season: "10 月初南岸瀑布水雾大，黑沙滩风浪也大，照片很出片但要离浪线远一点。", images: ["assets/spots/tourlink/nice-south-waterfall-1.jpg", "assets/spots/reynisfjara.jpg", "assets/spots/gallery/reynisfjara-seljalandsfoss.jpg", "assets/spots/gallery/reynisfjara-skogafoss.jpg"] },
  "jianhuang|10/05": { city: "冰岛南岸", sunrise: "07:36", sunset: "18:34", season: "10 月初蓝冰洞季刚开始，冰河湖和钻石沙滩的光线偏冷，很适合看冰川景观。", images: ["assets/spots/iceland/jokulsarlon-1.jpg", "assets/spots/iceland/jokulsarlon-2.jpg", "assets/spots/iceland/diamond-beach-1.jpg"] },
  "jianhuang|10/06": { city: "Sky Lagoon / 雷克雅未克 / 凯夫拉维克", sunrise: "07:50", sunset: "18:40", season: "10 月初泡温泉很适合放松；11:00 入场，14:00 左右回城，之后只安排轻量逛街和机场交通。", images: ["assets/spots/iceland/blue-lagoon-1.jpg", "assets/spots/iceland/reykjavik-coast.jpg", "assets/spots/iceland/reykjavik-harpa.jpg"] },
  ...
  "haigang|10/03": { city: "雷克雅未克 / 黄金圈", sunrise: "07:41", sunset: "18:50", season: "10 月初冰岛早晚冷；早上落地后先寄存行李，约 10:00 跟建皇组合会合、吃早午饭，下午看黄金圈，晚上还要追极光。", images: ["assets/spots/gullfoss.jpg", "assets/spots/iceland/thingvellir-1.jpg", "assets/spots/iceland/strokkur-1.jpg"] },
  "haigang|10/04": { city: "冰岛南岸", sunrise: "07:33", sunset: "18:38", season: "南岸瀑布和黑沙滩在 10 月初很有戏剧感，防风防水最重要。", images: ["assets/spots/tourlink/nice-south-waterfall-1.jpg", "assets/spots/reynisfjara.jpg", "assets/spots/gallery/reynisfjara-seljalandsfoss.jpg", "assets/spots/gallery/reynisfjara-skogafoss.jpg"] },
  "haigang|10/05": { city: "冰岛南岸", sunrise: "07:36", sunset: "18:34", season: "蓝冰洞、冰河湖和钻石沙滩是这天的核心，光线偏冷，拍照很好看。", images: ["assets/spots/iceland/jokulsarlon-1.jpg", "assets/spots/iceland/jokulsarlon-2.jpg", "assets/spots/iceland/diamond-beach-1.jpg"] },
  "haigang|10/06": { city: "雷克雅未克", sunrise: "07:50", sunset: "18:40", season: "建皇离开后，四人段适合按天气补斯奈山、雷克雅内斯半岛 / 蓝湖，或雷克雅未克周边轻量线。", images: ["assets/spots/iceland/reykjavik-hallgrimskirkja.jpg", "assets/spots/iceland/reykjavik-harpa.jpg", "assets/spots/iceland/reykjavik-coast.jpg"] },
  ...
  "haigang|10/08": { city: "雷克雅未克 / 阿姆斯特丹", sunrise: "07:55", sunset: "18:33", season: "离开冰岛当天不要跑远，适合蓝湖或机场附近轻量收尾。", images: ["assets/spots/iceland/blue-lagoon-1.jpg", "assets/spots/iceland/reykjavik-coast.jpg", "assets/spots/city/amsterdam-canal.jpg"] },
  ...
  "tongyan|10/04": { city: "冰岛南岸", sunrise: "07:33", sunset: "18:38", season: "南岸 10 月初瀑布、黑沙滩和低云很有冰岛感。", images: ["assets/spots/tourlink/nice-south-waterfall-1.jpg", "assets/spots/reynisfjara.jpg", "assets/spots/gallery/reynisfjara-dyrholaey.jpg", "assets/spots/gallery/reynisfjara-skogafoss.jpg"] },
  "tongyan|10/05": { city: "冰岛南岸", sunrise: "07:36", sunset: "18:34", season: "冰河湖、钻石沙滩和蓝冰洞是冷色系景观，注意保暖和防滑。", images: ["assets/spots/iceland/jokulsarlon-1.jpg", "assets/spots/iceland/jokulsarlon-2.jpg", "assets/spots/iceland/diamond-beach-1.jpg"] },
  ...
  "niangniang|09/26": { city: "里斯本周边", sunrise: "07:27", sunset: "19:27", season: "辛特拉和罗卡角是葡萄牙海边秋日感最强的一天。", images: ["assets/spots/portugal/cabo-da-roca-sunset.jpg", "assets/spots/portugal/boca-do-inferno.jpg", "assets/spots/portugal/regaleira-initiation-well.jpg", "assets/spots/portugal/sintra-national-palace.jpg", "assets/spots/portugal/pena-palace-exterior.jpg"] },
...
const iconicImageRules = [
  ...
  },
  {
    ...
    images: ["assets/spots/iceland/blue-lagoon-1.jpg", "assets/spots/iceland/reykjavik-coast.jpg", "assets/spots/city/amsterdam-canal.jpg"],
    replace: true,
  },
  ...
  { match: (_, visual) => visual.city.includes("雷克雅未克") && visual.city.includes("斯奈山"), images: ["assets/spots/tourlink/snaefellsnes-aa-1.jpg", "assets/spots/tourlink/snaefellsnes-aa-2.jpg", "assets/spots/tourlink/snaefellsnes-aa-3.jpg"], replace: true },
  { match: (_, visual) => visual.city.includes("斯奈山"), images: ["assets/spots/tourlink/snaefellsnes-aa-1.jpg", "assets/spots/tourlink/snaefellsnes-aa-2.jpg", "assets/spots/tourlink/snaefellsnes-aa-3.jpg"], replace: true },
...
function getDailyStay(personId, date, title) {
  const lisbonStay = {
    label: "住宿",
    name: "The Delight Hostel（欢乐青年旅馆）",
    detail: "09/25-09/27 三人间已订；点开可跳转谷歌地图。",
...
const icelandRouteDays = [
  {
    ...
    caution: "浮潜团按 12:00 场次；落地后先放行李、换保暖衣物，集合时间以确认单为准。",
    images: ["assets/spots/tourlink/silfra-snorkel-1.jpg", "assets/spots/tourlink/silfra-snorkel-2.jpg"],
    points: [
      [120, 474, "凯夫拉未克机场", "机场"],
      [183, 452, "雷克雅未克", "城市 / 住宿"],
  ...
  },
  {
    ...
    images: ["assets/spots/iceland/landmannalaugar-1.jpg", "assets/spots/iceland/landmannalaugar-2.jpg"],
    points: [
      [183, 452, "雷克雅未克", "出发 / 住宿"],
  ...
  },
  {
    ...
    stay: "Fosshotel Lind（林德城河酒店），雷克雅未克",
    caution: "全天小团车程长，海岸步道按风况开放；停靠顺序以 Arctic Adventures 确认单为准。",
    images: ["assets/spots/season/snaefellsnes-autumn.jpg", "assets/spots/tourlink/snaefellsnes-aa-1.jpg"],
    points: [
      [183, 452, "雷克雅未克", "出发 / 住宿"],
  ...
  },
  {
    ...
    stay: "Fosshotel Lind（林德城河酒店），雷克雅未克",
    caution: "高地道路不适合普通车辆；徒步时长、温泉停留与实际回城时间以团方确认单为准。",
    images: ["assets/spots/tourlink/landmannalaugar-aa-1.jpg", "assets/spots/iceland/landmannalaugar-3.jpg"],
    points: [
      [183, 452, "雷克雅未克", "出发 / 住宿"],
      [273, 478, "Hella", "高地入口"],
  ...
  },
  {
    ...
    roads: "黄金圈主线走 36 号路、37 号路和 35 号路；下午团结束后回雷克雅未克，晚上再参加追极光团。",
    terrain: "裂谷断层、间歇泉地热区与宽阔瀑布峡谷，是冰岛最集中的地质景观组合。",
    stay: "Fosshotel Lind（林德城河酒店），雷克雅未克",
    caution: "建皇上午休息，约 10:00 和海港组会合吃早午饭；黄金圈下午团为已订项目。",
    images: ["assets/spots/tourlink/whale-golden-thingvellir.jpg", "assets/spots/gallery/gullfoss-strokkur.jpg"],
    points: [
      [183, 452, "雷克雅未克", "早午饭 / 出发"],
      [270, 399, "辛格维利尔", "裂谷"],
      [350, 402, "Geysir", "间歇泉"],
      [391, 428, "Gullfoss", "黄金瀑布"],
      [183, 452, "雷克雅未克", "住宿 / 追极光"],
    ],
  },
  {
    id: "1004",
    ...
    caution: "10/04 晚为团含住宿和早餐，住宿城市及接送点不要自行假设，以确认单为准。",
    images: ["assets/spots/tourlink/nice-south-waterfall-1.jpg", "assets/spots/gallery/reynisfjara-seljalandsfoss.jpg"],
    points: [
      [183, 452, "雷克雅未克", "出发"],
  ...
  },
  {
    ...
    stay: "Fosshotel Lind（林德城河酒店），雷克雅未克",
    caution: "蓝冰洞的集合位置、入洞时间与是否包含 Skaftafell 以最终确认单为准。",
    images: ["assets/spots/iceland/jokulsarlon-1.jpg", "assets/spots/iceland/diamond-beach-1.jpg"],
    points: [
      [548, 492, "南部住宿", "出发"],
      [621, 486, "蓝冰洞接驳区", "冰川向导"],
  ...
  },
  {
    ...
    images: ["assets/spots/iceland/blue-lagoon-1.jpg", "assets/spots/iceland/reykjavik-coast.jpg"],
    points: [
...
function renderRouteAtlas(dayId = activeRouteDayId) {
  ...
  routeAtlasDetailEl.innerHTML = `
    ...
    <div class="route-day-detail__media">
      ${selectedDay.images.map((image, index) => `<figure><img src="${image}" alt="${selectedDay.title}景观缩影 ${index + 1}" loading="lazy" /><figcaption>${index === 0 ? selectedDay.terrain : "当天路线相关景观"}</figcaption></figure>`).join("")}
    </div>
  `;
}
